...
/**
 * <p>Test case for <code>FloatValidator</code>.</p>
 */
public class FloatValidatorTestCase extends AbstractJsfTestCase {
    ...
    public FloatValidatorTestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        return (new TestSuite(FloatValidatorTestCase.class));
     ...
     */
    private FloatValidator validator = null;
...
//            System.err.println("a: " + e.getFacesMessage().getSummary());
    ...
    public void testInvalidMaximum() {
        ...
        validator.setMaximum((float) 123);
        try {
            validator.validate(facesContext, input, new Float((float) 234));
            fail("Should have thrown ValidatorException");
        } catch (ValidatorException e) {
            ; // Expected result
//            System.err.print("234: " + e.getFacesMessage().getSummary());
    ...
    public void testInvalidMinimum() {
        ...
        validator.setMinimum((float) 234);
        try {
            validator.validate(facesContext, input, new Float((float) 123));
            fail("Should have thrown ValidatorException");
        } catch (ValidatorException e) {
            ; // Expected result
//            System.err.print("123: " + e.getFacesMessage().getSummary());
    ...
    public void testInvalidRange() {
        ...
        validator.setMinimum((float) 0);
        validator.setMaximum((float) 234);
        try {
            validator.validate(facesContext, input, new Float((float) -1));
            fail("Should have thrown ValidatorException");
        } catch (ValidatorException e) {
            ; // Expected result
//            System.err.println("-1: " + e.getFacesMessage().getSummary());
        ...
        validator.setMaximum((float) 234);
        try {
            validator.validate(facesContext, input, new Float((float) 235));
            fail("Should have thrown ValidatorException");
        } catch (ValidatorException e) {
            ; // Expected result
//            System.err.println("-1: " + e.getFacesMessage().getSummary());
    ...
    public void testValidInput() {
        ...
        try {
            validator.validate(facesContext, input, new Float((float) 0));
        } catch (ValidatorException e) {
        ...
        try {
            validator.validate(facesContext, input, new Float((float) -456));
        } catch (ValidatorException e) {
            fail("Should not have thrown ValidatorException: " +
                    e.getFacesMessage().getSummary());
        }
