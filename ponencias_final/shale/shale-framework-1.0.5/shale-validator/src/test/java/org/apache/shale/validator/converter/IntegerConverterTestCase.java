...
/**
 * <p>Test case for <code>IntegerConverter</code>.</p>
 */
public class IntegerConverterTestCase extends AbstractJsfTestCase {
    ...
    private static final Integer[] VALID_OBJECTS =
     ...
     */
    private IntegerConverter converter = null;
    ...
    public void testValidObject() {
        ...
        for (int i = 0; i < VALID_OBJECTS.length; i++) {
            Integer value = VALID_OBJECTS[i];
            try {
                String string = converter.getAsString(facesContext, input, value);
                assertEquals("Integer value " + value
                             + " equals String value " + string,
                  value.intValue(), Integer.valueOf(strip(string)).intValue());
