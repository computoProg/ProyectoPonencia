 ...
 * and (optional) range checks on a Short value.</p>
 */
public final class ShortValidator extends AbstractValidator
  implements StateHolder {
    ...
    private static final
      org.apache.commons.validator.routines.ShortValidator INSTANCE =
      org.apache.commons.validator.routines.ShortValidator.getInstance();
    ...
    public void validate(FacesContext context,
        ...
        if (!(value instanceof Short)) {
            throw new ValidatorException
              (new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                message(context, "Short.unconverted"),
                                null));
        }
        ...
        if (minimumSet) {
            if (maximumSet) {
                if (!INSTANCE.isInRange(svalue, minimum, maximum)) {
                    throw new ValidatorException
                      (new FacesMessage(FacesMessage.SEVERITY_ERROR,
                ...
                if (!INSTANCE.minValue(svalue, minimum)) {
                    throw new ValidatorException
                      (new FacesMessage(FacesMessage.SEVERITY_ERROR,
            ...
            if (!INSTANCE.maxValue(svalue, maximum)) {
                throw new ValidatorException
                  (new FacesMessage(FacesMessage.SEVERITY_ERROR,
    ...
    public void restoreState(FacesContext context, Object state) {
        ...
        maximum = ((Short) values[1]).shortValue();
        maximumSet = ((Boolean) values[2]).booleanValue();
        minimum = ((Short) values[3]).shortValue();
    ...
    public Object saveState(FacesContext context) {
        ...
        values[1] = new Short(maximum);
        values[2] = this.maximumSet ? Boolean.TRUE : Boolean.FALSE;
        values[3] = new Short(minimum);
