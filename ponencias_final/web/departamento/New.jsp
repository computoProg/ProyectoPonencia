...
<f:view>
    <html>
        ...
        <h:form>
            <h:inputHidden id="validateCreateField" validator="#{Departamento.validateCreate}" value="value"/>
            <h:panelGrid columns="2">
                <h:outputText value="Departamento:"/>
                <h:inputText id="departamento" value="#{Departamento.departamento.nombre}" title="Departamento" required="true" requiredMessage="The Departamento field is required." />

                <h:outputText value="Pais:"/>
                <h:selectOneMenu id="pais" value="#{Departamento.departamento.paisidPais}" title="Pais" required="true" requiredMessage="The Pais field is required." >
                    <f:selectItems value="#{Pais.paisItemsAvailableSelectOne}"/>
                </h:selectOneMenu>

            </h:panelGrid>
            <br />
            <h:commandButton action="#{Departamento.create}" value="Crear"/>
            <br />
            <br />
            <h:commandButton action="#{Departamento.listSetup}" value="Mostrar participantes" immediate="true"/>
            <br />
            <br />
